...
Add a changeset when your PR includes **user-facing** changes to the published `nanoclaw-agenttrace` package (CLI, host/runner resources, skill, or docs shipped in the npm tarball).
...
Private workspace packages (`@nanoclaw-agenttrace/*`) are ignored by Changesets; only the root package is published.
